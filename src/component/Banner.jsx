      ...
      <div className="container px-4 my-5">
        ...
        <div className="row gx-5 gy-5">
          <div className="col-lg-4 col-md-6">
            <div className="Category" onClick={handleTopClick}>
             
                <button type="button" className="btn btn-outline-primary shopbtn">
                  Shop Tops
                </button>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="Category Category2" onClick={handleTrousersClick}>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="Category Category3" onClick={handleDressClick}>
